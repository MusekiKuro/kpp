        ...
        <div className="flex h-16 items-center justify-between">
          ...
          <nav className="hidden md:flex items-center gap-1">
            {NAV_LINKS.map((link) => (
              <a
                key={link.href}
                href={link.href}
                className="nav-link px-3 py-2 text-sm font-semibold text-slate-700 hover:text-brand-600 transition-colors"
              >
                {link.label}
              </a>
            ))}
          ...
          <div className="flex items-center gap-3">
            ...
            <a
              ...
              className="hidden sm:inline-flex items-center gap-2 rounded-xl bg-[#25D366] px-5 py-2.5 text-sm font-bold text-white shadow-md hover:shadow-lg hover:shadow-[#25D366]/40 hover:-translate-y-0.5 transition-all"
            >
