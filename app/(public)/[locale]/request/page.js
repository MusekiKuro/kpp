...
const REQUESTS_DISABLED_COPY = {
  ru: 'Приём заявок временно приостановлен: мы завершаем оформление юридической информации.',
  kk: 'Өтінімдерді қабылдау уақытша тоқтатылды: заңды ақпаратты рәсімдеуді аяқтап жатырмыз.',
}
...
export default function RequestPage() {
  ...
  const quoteRequestsEnabled = process.env.NEXT_PUBLIC_QUOTE_REQUESTS_ENABLED === 'true'
